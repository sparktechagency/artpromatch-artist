            ...
            <div className="pt-32 pb-16">
                <div className="">
                   ...
                   <Image src={AllImages. logo} width={50} height={50} alt='logo'></Image>
                                ...
                                <h2 className="text-center text-2xl font-bold mt-6 mb-2 text-primary font-"> Zuhran Ahmad</h2>
                                <Typography.Text className=" text-center text-base ">
                                    Let’s set up your profile to help you showcase your art and connect with clients.
                                </Typography.Text>
                            </div>
