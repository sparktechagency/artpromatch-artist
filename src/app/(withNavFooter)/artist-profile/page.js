...
const ArtistProfilePage = ({ children }) => {
    const data = [
        {
            name: "Alex Rivera",
            date: "2 days ago",
        ...
        <div className=''>
            ...
            <div className='container mx-auto  flex flex-col md:flex-row my-10'>
                ...
                <div className='w-[80%] px-5'>
                    <div>
                        <h1 className='text-2xl font-bold flex gap-2 items-center'>About Alex Rivera <LuPenLine onClick={showModal} className='bg-primary text-white h-7 w-7 p-1 rounded-full' /></h1>
                        <p> I’m a professional tattoo artist with over 10 years of experience specializing in realism and black & grey designs. My focus is on creating lifelike portraits and intricate custom designs for clients who want their tattoos to tell a story.</p>
                    </div>
                    <div className=''>
                            ...
                            {data.map((item, index) => (
                                <div key={index} className="relative group overflow-hidden">
                                    ...
                                    >
                                        ...
                                        <button onClick={showModal} className="cursor-pointer bg-white text-black px-4 py-2 rounded-xl absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 shadow-md scale-75 opacity-0 group-hover:scale-100 group-hover:opacity-100 transition-all duration-300 ease-in-out"
                                        >
                                            Book Now
                                        </button>
