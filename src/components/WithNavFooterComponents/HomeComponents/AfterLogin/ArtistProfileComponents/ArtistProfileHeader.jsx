        ...
        <div>
            <div className='flex flex-col lg:flex-row justify-between items-center gap-5 lg:gap-0 my-5'>
                <div className='flex flex-col lg:flex-row justify-start items-center gap-2'>
                    <Image src={AllImages.user} alt='logo' height={160} width={160} className='h-40 w-40 md:h-32 md:w-32 xl:h-52 xl:w-52 top-56 md:top-48 lg:top-56 xl:top-64   rounded-full border-2 border-white lg:absolute  absolute'></Image>
                ...
                <div className='flex flex-col lg:flex-row justify-center items-center gap-2'>
                    ...
                    <button className='px-3 py-1 rounded-xl border flex justify-center items-center gap-2 bg-primary text-white'>Available Now</button>


                    <Link href="/availability">
                        <button className='px-3 py-1 rounded-xl  flex justify-center items-center gap-2 border border-primary text-primary'><SlCalender className='h-4 w-4 ' />Set Availability</button>
                    </Link>
                </div>
