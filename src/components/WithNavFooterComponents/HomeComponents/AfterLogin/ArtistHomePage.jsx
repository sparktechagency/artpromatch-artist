            ...
            <div className='flex flex-col md:flex-row justify-between items-center md:mt-16 md:mb-10'>
                <div className='flex justify-start items-center gap-3'>
                    ...
                    <div>
                        ...
                        <p className='text-textSecondary'>Here’s what’s happening with your profile today.</p>
                    </div>
                </div>
                <div className='flex justify-center items-center gap-5'>
                    <button className=' px-6 py-2 rounded-lg border'>View Profile</button>
                    <Link href="/discover">
                        <button className=' px-6 py-2 rounded-lg border bg-primary text-white'>Discover</button>
                    </Link>
                </div>
