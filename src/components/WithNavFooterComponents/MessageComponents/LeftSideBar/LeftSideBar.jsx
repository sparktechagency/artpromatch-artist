    ...
    return (
        <div className="container mx-auto p-6">
            ...
            <div className=" ">
                ...
                {isLoading && <p className=" text-center px-2 py-2 shadow-md shadow-neutral-400 mb-5">Loading users...</p>}
                <Link
                    href=""
                    // to={{
                    ...
                    <div className="flex justify-start items-center gap-2">
                        <Image className="w-10 h-12 rounded-full" src={AllImages.user} alt="" />
                        <div>
                            <h3 className="text-xl font-semibold text-textSecondary">Luci Santos</h3>
